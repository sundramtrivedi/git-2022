...
SELECT LMS_MEMBERS.MEMBER_NAME,LMS_BOOK_DETAILS.BOOK_CODE, LMS_BOOK_DETAILS.PUBLICATION, LMS_BOOK_DETAILS.PRICE, LMS_SUPPLIERS_DETAILS.SUPPLIER_NAME
FROM LMS_MEMBERS
...
SELECT DISTINCT LMS_MEMBERS.MEMBER_ID, LMS_MEMBERS.MEMBER_NAME
FROM LMS_MEMBERS
INNER JOIN LMS_BOOK_ISSUE ON (LMS_MEMBERS.MEMBER_ID = LMS_BOOK_ISSUE.MEMBER_ID)
...
SELECT PUBLICATION, COUNT(*) NO_OF_BOOKS
FROM LMS_BOOK_DETAILS
...
WHERE LMS_BOOK_ISSUE.DATE_ISSUE = TO_DATE('1-APR-2012', 'DD-MM-YYYY');
...
FROM LMS_MEMBERS
WHERE DATE_EXPIRE < TO_DATE('1-APR-2013', 'DD-MM-YYYY');
...
FROM LMS_MEMBERS
WHERE DATE_REGISTER < TO_DATE('1-MAR-2012', 'DD-MM-YYYY') AND MEMBERSHIP_STATUS = 'Temporary';
...
FROM LMS_MEMBERS
WHERE CITY IN ('CHENNAI', 'Chennai', 'DELHI', 'Delhi');
...
SELECT DISTINCT BOOK_TITLE, AUTHOR, (BOOK_TITLE || '_IS_WRITTEN_BY_' || AUTHOR) BOOK_WRITTEN_BY
FROM LMS_BOOK_DETAILS;
